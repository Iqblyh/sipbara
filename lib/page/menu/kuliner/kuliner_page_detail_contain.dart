...
class KulinerDetailWidget extends StatefulWidget {
  final Kuliner kuliner;
  const KulinerDetailWidget({Key? key, required this.kuliner})
      : super(key: key);

  @override
  _KulinerDetailWidgetState createState() => _KulinerDetailWidgetState();
}

class _KulinerDetailWidgetState extends State<KulinerDetailWidget> {
