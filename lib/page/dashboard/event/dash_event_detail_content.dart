...
class EventDetailAdminWidget extends StatefulWidget {
  final Event event;
  const EventDetailAdminWidget({Key? key, required this.event})
      : super(key: key);

  @override
  _EventDetailAdminWidgetState createState() => _EventDetailAdminWidgetState();
}

class _EventDetailAdminWidgetState extends State<EventDetailAdminWidget> {
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                  ...
                                  context: context,
                                  builder: (context) {
                                    final subPath = widget.event.nama_event
                                        .toLowerCase()
                                        .replaceAll(' ', '_');
                                    final idEvent = widget.event.id;
                                    return AddImageModalEvent(
                                      idEvent: idEvent,
                                      subPath: subPath,
                                    );
                                  });
