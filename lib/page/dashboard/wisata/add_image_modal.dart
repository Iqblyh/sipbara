...
class AddImageModal extends StatefulWidget {
  ...
  AddImageModal({super.key, required this.subPath, required this.idWisata});

  @override
  State<AddImageModal> createState() => _AddImageModalState();
}
                      ...
                      child: isLoading == false
                          ? SIPEleButton_Large_Icon(
                              onPressed: () async {
                                ...
                                await Storage()
                                    .uploadMedia(
                                        _image, widget.subPath, widget.idWisata)
                                    .whenComplete(
