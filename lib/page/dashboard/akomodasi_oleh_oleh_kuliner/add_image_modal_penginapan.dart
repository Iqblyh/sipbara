...
class AddImageModalPenginapan extends StatefulWidget {
  final String subPath;
  final String idPenginapan;
  AddImageModalPenginapan(
      {super.key, required this.subPath, required this.idPenginapan});

  @override
  State<AddImageModalPenginapan> createState() =>
      _AddImageModalPenginapanState();
}

class _AddImageModalPenginapanState extends State<AddImageModalPenginapan> {
  List<File> _image = [];
                      ...
                      child: isLoading == false
                          ? SIPEleButton_Large_Icon(
                              onPressed: () async {
                                ...
                                await Storage()
                                    .uploadMediaPenginapan(_image,
                                        widget.subPath, widget.idPenginapan)
                                    .whenComplete(
